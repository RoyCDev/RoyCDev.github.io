...
function AboutPage() {
    ...
    return (
        <section>
            <h1 className="text-xl sm:text-2xl font-medium mb-3">Roy Cheung</h1>
            ...
            <h2 className="text-lg sm:text-xl font-medium mb-3">More about me</h2>
            <p className="mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-medium mb-3">Experience</h2>
